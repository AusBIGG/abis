...
This Specification is normative for the ABIS and take precedence over other elements of the Standard where conflics are found.
...
This document is a list of _requirements_ for data to meet in order to conform to the link:https://linked.data.gov.au/def/abis[Australian Biodiversity Information Standard]. Each _requirement_ is defined with a table of values like this:
...
include::15_annex_a_bdr_messages.adoc[]