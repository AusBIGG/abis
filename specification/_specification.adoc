...
The normative listing of requirements for data conformig to the Australian Biodiversity Information Standard for Biodiversity Data (ABIS).
...
** A not-so-technical introduction to ABIS
* _Schema_
...
* _Mappings_
** Instructions on how to convert BDR data to data conforming to other Standards
