...
image::examples/sample-positioning.png[Options for the spatial positioning of `tern:Sampling` instances]
...
<https://linked.data.gov.au/dataset/bdr/sampling/x>
	sosa:resultTime "2021-12-09"^^xsd:dateTime ; 
	geo:sfWithin <https://linked.data.gov.au/dataset/asgs2021/lga/canning> ;
.

<https://linked.data.gov.au/dataset/asgs2021/lga/canning>
