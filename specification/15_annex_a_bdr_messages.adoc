...
<message/1234>
    ...
    bdrm:absorbtionStatus status:submitted ;
.
```
...
<message/1234>
    a bdrm:CreateMessage ;
    bdrm:absorbtionStatus status:duplicate ;
...
<message/1234>
    a bdrm:CreateMessage ;
    bdrm:absorbtionStatus status:notduplicate ;
.
```
...
<message/1234>
    a bdrm:CreateMessage ;
    bdrm:absorbtionStatus status:badvalues ;
    bdrm:failed 
        req:ValuesReqK ,
        req:ValuesReqL ;
.
...
<message/1234>
    a bdrm:CreateMessage ;
    bdrm:absorbtionStatus status:goodvalues ;
.
```
...
<message/1234>
    a bdrm:CreateMessage ;
    bdrm:absorbtionStatus status:notexpanded ;
    bdrm:failed
        rul:ExpRuleM ,
        rul:ExpRuleN ;        
.
...
<message/1234>
    a bdrm:CreateMessage ;
    bdrm:absorbtionStatus status:expanded ;
.
```
...
<message/1234>
    a bdrm:CreateMessage ;
    bdrm:absorbtionStatus status:notstaged ;
...
<message/1234>
    a bdrm:CreateMessage ;
    bdrm:absorbtionStatus status:staged ;
```
...
<message/1234>
    a bdrm:CreateMessage ;
    bdrm:absorbtionStatus status:notlive ;
...
<message/1234>
    a bdrm:CreateMessage ;
    bdrm:absorbtionStatus status:live ;
```
