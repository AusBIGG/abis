...
ex:dataset-01
    a schema:Dataset ;
    schema:description "A schema:Dataset instance" ;
    schema:title "BDR Dataset 01" ;
.
ex:submission-01
    a ternRDF:Dataset ;
    dcterms:description "A minimally valid tern:RDFDataset instance" ;
    dcterms:issued "2021-11-18"^^xsd:date ;
    dcterms:title "TERN Submission 01" ;
.

ex:obs-01
    a tern:Observation ;
    rdfs:label "TERN Observation 01" ;
    void:inDataset ex:submission-01 ;
    schema:isPartOf ex:dataset-01 ;
    geo:hasGeometry [
        a geo:Geometry ;
