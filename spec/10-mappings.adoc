...
The TERN Ontology makes the following mappings to <<Darwin Core Terms, Darwin Core Terms>> elements:
...
| https://dwc.tdwg.org/list/#dwc_MaterialSample[dwc:MaterialSample] | http://www.w3.org/2000/01/rdf-schema#subClassOf[rdfs:subClassOf] | https://w3id.org/tern/ontologies/tern/Sample[tern:Sample]
...
The following Darwin Core Terms classes have more complex mappings:

* https://dwc.tdwg.org/list/#dwc_Occurrence[dwc:Occurrence]
