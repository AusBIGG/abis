...
3+| *Classes*
| https://w3id.org/tern/ontologies/tern/Dataset[tern:Dataset] | http://www.w3.org/2000/01/rdf-schema#subClassOf[rdfs:subClassOf] | https://www.w3.org/TR/prov-o/#Entity[prov:Entity]
