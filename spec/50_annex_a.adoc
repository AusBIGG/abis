...
[#brd-overview,link="img/annex-a/brm-overview.svg"]
...
[#brm-join,link="img/annex-a/brm-join.svg"]
.Class equivalences between this Biodiversity Record Model, <<SDO, schema.org>> and <<DCAT, DCAT>>
image::img/annex-a/brm-join.svg[Biodiversity Record Model class equivalences,align="center",width=60%]

[#brm-occurrence,link="img/annex-a/brm-occurrence.svg"]
.Biodiversity Record Model occurrence modelling
image::img/annex-a/brm-occurrence.svg[Biodiversity Record Model occurrence modelling,align="center",width=60%]
...
|*https://schema.org/name[Name]* | ABIS Biodiversity Record Model
...
|*https://schema.org/dateModified[Modified Date]* | 2025-07-24
