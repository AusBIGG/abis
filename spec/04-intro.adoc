...
Biodiversity data in ABIS primarily refers to species occurrence data: observations of organisms at a place and time. This includes records relating to common and rare species, and native, introduced, naturalised and feral species. ABIS also supports associated information required for the management and exchange of biodiversity data, including sampling methods, taxonomic identification, provenance, institutional information and related metadata.
