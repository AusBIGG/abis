...
|*https://schema.org/dateModified[Modified Date]* | 2025-11-28
...
*2.8* - 2025 Nov - Wording and Role adjustments to better align with the https://linked.data.gov.au/def/supermodel[Supermodel Model]
