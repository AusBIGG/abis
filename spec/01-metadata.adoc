...
|*https://schema.org/dateModified[Modified Date]* | 2024-10-10
|*https://schema.org/dateIssued[Issued Date]* | 2023-12-04
|*https://schema.org/version[Version]* | 2.5
|*https://www.w3.org/TR/2012/REC-owl2-syntax-20121211/#Ontology_IRI_and_Version_IRI[Version IRI]* | https://linked.data.gov.au/def/abis/2.3[abis:2.5]
