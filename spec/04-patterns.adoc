...
* <<Centroid & Bounding Box Reasoning, Centroid & Bounding Box Reasoning>>
* <<Geometry Literals, Geometry Literals>>
* <<Spatial Aggregation Reasoning, Spatial Aggregation Reasoning>>
