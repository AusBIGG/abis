...
The preferred way to validate RDF data using the validators above is to use the https://resources.bdr.gov.au[BDR Resources] which contains all the validators preloaded for use.
...
* https://tools.kurrawong.ai/validate[KurrawongAI SHACL Validator]
** free, online pySHACL-based validator
** preloaded with the validators above and many others
* https://graphdb.ontotext.com/documentation/11.3/shacl-validation.html[GraphDB's SHACL Validation capability]
